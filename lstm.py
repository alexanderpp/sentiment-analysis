...
timesteps = 400
dimensions = 300
batch_size = 64       # TODO: test this (not tested yet)
epochs_number = 40

print "Loading data..."
train_X = np.load("./x6_train.save.npy")
train_Y = np.load("./y6_train.save.npy")
test_X = np.load("./x6_test.save.npy")
test_Y = np.load("./y6_test.save.npy")
